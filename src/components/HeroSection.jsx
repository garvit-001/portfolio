...
import lamp_toggle from "../assets/study_room_lamp_toggle.gif"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 place-items-center">
          ...
          >
            <h1 className="text-white mb-4 text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-[700] lg:leading-normal">
              Hi, I&apos;m <span className="text-heading">Garvit</span> a{" "}
              <span className="text-heading">passionate</span> Software
              Developer.
            </h1>
            ...
            <TypeAnimation
              ...
              sequence={[
                ...
                1000,
                "I build interactive UI using React and Node.js.",
                1000,
            ...
            <div className="flex items-center gap-4 flex-col sm:flex-row ">
              ...
              <a
                href="https://drive.google.com/drive/u/1/folders/1JpjLS-ikViJT-HMVaSrF7WzpyzONER1s"
                target="_blank"
